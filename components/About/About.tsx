  ...
  return (
    <div className={styles.about} id="about">
      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 md:grid-cols-2 flex md:gap-10 items-center">
          ...
          <div className={styles.about_content}>
            ...
            <p>
              Hello there! I&apos;m a Web App Developer, and I&apos;m very
              passionate and dedicated to my work. With 1 years experience as a
              professional Web App Developer, I have acquired the skills and
