                ...
                <div className='grid lg:grid-cols-3'>
                    ...
                    return (
                            <div className={styles.port_box} key={data.id}>
                                <Link href={data.image} data-fancybox="gallery" data-caption={data.name}>
                                    <Image src={data.image} className={styles.port_image} width={350} height={350} alt={data.name} />
                                </Link>
                                <h1>{data.name}</h1>
                                <div className={styles.websiteLinkDiv}>
                                    <Link href={data.link} className={styles.websiteLink}  target="_blank">{data.link}</Link>
                                </div>
                            </div>
                    )
                })}
